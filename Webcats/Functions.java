public class Functions {
	...
	public static void main(String[] args) {
		...
		System.out.println(quadraticSolution(1,7,12)); 
	...
	public static String firstAndLast(String str) {
		return str.length() > 1 ? str.replaceAll("(?<=.+).*(?=.+)", "") : str + str;
	}
	...
	public static String middleCapitalization(String str) {
		return str.length() > 2 ? Character.toLowerCase(str.charAt(0)) + str.split("^.|.$")[1].toUpperCase() + Character.toLowerCase(str.charAt(str.length()-1)) : str.toLowerCase();
	}
